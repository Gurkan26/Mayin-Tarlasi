...
public class Orta  implements ActionListener{
 ...
 int süre =0;
    ...
    reset.setPreferredSize(new Dimension(40,40));
        ...
        ara1.setPreferredSize(new Dimension(120,30));
                ara2.setPreferredSize(new Dimension(120,30));
        ara3.setPreferredSize(new Dimension(120,30));
        ara4.setPreferredSize(new Dimension(120,30));
...
//----------------
  ...
  puansayısı=puansayısı+Integer.valueOf(butonlar[x+1][y].getText());
       ...
       public void bombasesi()
    {
        ...
        try {
            ...
            Logger.getLogger(Orta.class.getName()).log(Level.SEVERE, null, ex);
 ...
 if(e.getSource()==baslangıc){
          frame.setVisible(false);
          MayınTarlasi_2 mytbaslangıc= new MayınTarlasi_2();
          mytbaslangıc.mayinyaratici();
            ...
            for (int i = 0; i < butonlar.length; i++) {
                for (int j = 0; j < butonlar[0].length; j++) {
                    if (e.getSource().equals(butonlar[i][j])) {
                        ...
                        butonlar[i][j].setIcon(mayınicon);
                 timer.cancel();
// eğer mayın var ise görüntüs bu olacak
